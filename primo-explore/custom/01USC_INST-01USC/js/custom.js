...
/* includes report a problem because they are all prmactionlistafter */
app.component('prmActionListAfter', {
    bindings: { parentCtrl: '<' },
    controller: 'ActionListAfterController',
    template: '<br><a href="https://libraries.usc.edu/form/need-help-report-problem" referrerpolicy="no-referrer-when-downgrade" target="_blank" style="float:right;" class="md-primoExplore-theme"><b>Need Help? Report a Problem</b></a>\n    <prm-action-list-after-app-store-generated parent-ctrl="$ctrl.parentCtrl"></prm-action-list-after-app-store-generated><prm-action-list-after-app-store-generated parent-ctrl="$ctrl.parentCtrl"></prm-action-list-after-app-store-generated>\n'
...
app.component('prmLoanAfter', {
    ...
    template: '\n    <prm-loan-after-app-store-generated parent-ctrl="$ctrl.parentCtrl"></prm-loan-after-app-store-generated><prm-loan-after-app-store-generated parent-ctrl="$ctrl.parentCtrl"></prm-loan-after-app-store-generated><prm-loan-after-app-store-generated parent-ctrl="$ctrl.parentCtrl"></prm-loan-after-app-store-generated>\n'
...
app.component('prmSearchResultAvailabilityLineAfter', {
    ...
    template: '\n    <primo-studio-browzine parent-ctrl="$ctrl.parentCtrl"></primo-studio-browzine><prm-search-result-availability-line-after-app-store-generated parent-ctrl="$ctrl.parentCtrl"></prm-search-result-availability-line-after-app-store-generated>\n'
